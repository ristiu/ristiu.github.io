const projects = [
  ...
  },
  {
    ...
    whatShifted: "This was the first time working on something where a design decision carried direct revenue risk at scale. The company is famous for \"honest price\" what you see is what you pay, no hidden booking fees, no sudden charges inflating your total at checkout. Every label choice had to hold up against that principle.\n\nTraveloka was also tech company with the largest design organisation I've been part of. More than 100 designers at the time, across different roles, function and business unit. Working at that scale changed how I think about alignment. Small changes need sign-off from multiple levels and business lines, all with legitimate stakes in the same decision. That's not bureaucracy. That's what responsible design looks like when the surface area is that big.",
