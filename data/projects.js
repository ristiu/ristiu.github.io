const projects = [
  ...
  },
  {
    ...
    direction: " Looking back to past and present. What would be the influences that matter in the near future? We decoded youth lifestyle trends across three time periods to answer: what's trending, why, and what's driving it. After seeing the patterns we explored a concept that blur digital and physical realms using lenticular photos, the kind that shift and move depending on the angle you view them. Physical, but alive. We tested reactions with three sample cards: a flat photo, a morphing lenticular photo, and a 3D lenticular photo. People were genuinely intrigued by the morphing one, it's like combination of physical and digital.\n\n We explored building it end to end. NFC chip embedded in the printed photo, tap it with your phone, and it pulls the full photo series from the cloud. We even designed a 360 degree adjustable camera rig to capture the right angles for the lenticular effect.",
